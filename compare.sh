...
# Sort output1.txt, remove any line starting with ; or blank lines, save to output1-1.txt
...
# Sort output1.txt, remove any line starting with ; or blank lines, save to output2-1.txt
